...
class MenuSetup {
	public function register() {
		...
		add_filter( 'rest_prepare_nav_menu_item', [ $this, 'prepare_nav_menu_item' ], 10, 2 );
	}
	 ...
	 */
	public function prepare_nav_menu( $response, $menu ) {
	 ...
	 * @return \WP_REST_Response
	 */
	public function prepare_nav_menu_item( $response, $item ) {
		$data = $response->get_data();
